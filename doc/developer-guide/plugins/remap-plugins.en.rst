...
Calls to :func:`TSRemapNewInstance` is guaranteed to be serialized. All calls to
:func:`TSRemapNewInstance` for a given new configuration is guaranteed to be called and
...
are going to be part of the new configuration by returning :macro:`TSREMAP_CONFIG_RELOAD_SUCCESS_PLUGIN_USED`
